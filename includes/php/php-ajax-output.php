...
if ($valid == true) {
	...
	mysql_select_db ( $database_metcdb, $metcdb );
	$query_Recordset1 = sprintf ( "SELECT * FROM discounts_customer WHERE customerid = %s AND discount_code = %s", GetSQLValueString ( $colname_Recordset1, "int" ), GetSQLValueString ( $_POST ['discount_code'], "text" ) );
