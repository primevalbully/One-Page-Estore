...
<div id="tabs">
  ...
  <div id="tabs-1">
    <table id="account-details-table">
      <thead>
        <tr>
          <th colspan="2">Account Details <a class="three-d-button" href="http://one-page-estore.com/">Modify</a></th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <tr>
          <th>Username</th>
          <td class="username editable_textarea"><?php echo @$row_rs_uspass['username']; ?></td>
        </tr>
        <tr>
          <th>Password</th>
          <td>
            <input id="change-password" class="three-d-button modify" value="Change Password">
            <div id="change-pw-dialog" title="Change User Password">"Please don't change the guest password please!"</div>
          </td>
        </tr>
        <tr>
          <th>Email</th>
  ...
  <div id="tabs-2">
    <table id="shipping-address">
      <thead>
        <th colspan="2">Shipping Address <a class="three-d-button modify" href="">Modify</a></th>
      </thead>
      <tbody>
        <tr>
          <th>Address</th>
  ...
  <div id="tabs-3">
    <table id="payment-address">
      <thead>
        <th colspan="2">Payment Address <a class="three-d-button modify" href="">Modify</a></th>
      </thead>
      <tbody>
        <tr>
          <th>Address</th>
  ...
  <div id="tabs-4">
        <table id="order-history">
            ...
            <tr>
                <th>Address</th>
                <td class="editable_textarea"><?php
                     //combine $bill_address1 and $bill_address2.
